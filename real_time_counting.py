...
input_video = "./input_images_and_videos/HorseChasing.mp4"

# By default I use an "SSD with Mobilenet" model here. See the detection model zoo (https://github.com/tensorflow/models/blob/master/research/object_detection/g3doc/detection_model_zoo.md) for a list of other models that can be run out-of-the-box with varying speeds and accuracies.
detection_graph, category_index = backbone.set_model('faster_rcnn_resnet101_kitti_2018_01_28', 'mscoco_label_map.pbtxt')
...
targeted_objects = "horse" # (for counting targeted objects) change it with your targeted objects
